        ...
        <base-material-card>
          <template v-slot:heading>
            ...
            <div class="subtitle-1 font-weight-light">
              Complete your suggesstion profile
            </div>
          </template>
            ...
            <v-container class="py-0">
              <v-row>
                ...
                >
                  <v-select
                    v-model="machine"
                    :items="getMachine(applied_process)"
                    attach
                    label="Machine"
                  />
                </v-col>
                ...
                >
                  <v-select
                    v-model="component"
                    :items="getComponent(machine, area)"
                    label="Component"
                  />
                </v-col>
                <v-col
    ...
    methods: {
      async createSuggestion () {
        ...
        const suggestionData = {
          owner: this.owner,
          owner_process: this.owner_process,
          applied_process: this.applied_process,
          area: this.area,
          machine: this.machine,
          categories: this.category,
          component: this.component,
          suggestion_name: this.suggestion_name,
      ...
      __submitToServer (data) {
        axios.post(`${server.baseURL}/suggestion`, data).then(data => {
          this.$router.push({ name: 'My Suggestions' })
        })
      },
      addDropFile (e) {
