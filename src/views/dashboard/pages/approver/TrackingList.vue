  ...
  <v-app id="inspire">
    <v-container fluid>
      <base-material-card
        ...
        title="Suggestions Tracking List"
        class="px-5 py-3"
      >
        <v-data-table
          :headers="headers"
                        ...
                        <v-row>
                          ...
                          >
                            <v-select
                              ...
                              :items="status"
                              label="Select suggestion status"
                            />
                          </v-col>
                          <v-col
                            cols="12"
                          ...
                          >
                            <v-select
                              v-model="editedItem.implementer"
                              :items="implementer"
                              label="Implemented by owner?"
                            />
                          </v-col>
                        </v-row>
                        <v-row>
  ...
  export default {
    ...
    methods: {
      fetchSuggestions () {
        ...
        axios
          .get(`${server.baseURL}/suggestion/process`, { params })
          .then(data => {
      ...
      approveAction () {
        ...
        const approveData = {
          ...
          implementer: this.editedItem.implementer,
          comment: this.editedItem.comment,
          status: this.editedItem.status,
        }
        setTimeout(() => this.__submitToServer(approveData), 1000)
      },
      __submitToServer (data) {
        axios.put(`${server.baseURL}/suggestion/approve`, data).then(data => {
