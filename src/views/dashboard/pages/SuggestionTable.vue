...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getTotalScore () {
        var total = parseInt(this.editedItem.score_submit) +
          parseInt(this.editedItem.score_approved) +
          parseInt(this.editedItem.score_cml4) +
          parseInt(this.editedItem.score_implemented) +
          parseInt(this.editedItem.score_byOwner)
        this.totalScore = 'Total Score: ' + total.toString()
      },
      getfileInfo () {
        this.editedfileInfo = []
        this.editedfileName = []
